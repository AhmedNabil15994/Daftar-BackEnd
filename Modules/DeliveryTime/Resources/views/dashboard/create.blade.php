...
@section('title', __('deliverytime::dashboard.times.routes.create'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('deliverytime::dashboard.times.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.times.store')}}">
                @csrf
                <div class="col-md-12">
                            ...
                            <div class="tab-pane active fade in" id="general">
                                ...
                                <div class="col-md-10">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-3">
                                          <div class="input-group">
                                              <input type="text" class="form-control timepicker timepicker-24" name="delivery_from">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-3">
                                          <div class="input-group">
                                              <input type="text" class="form-control timepicker timepicker-24" name="delivery_to">
                                              <span class="input-group-btn">
                                                  <button class="btn default" type="button">
                                                      <i class="fa fa-clock-o"></i>
                                                  </button>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-3">
                                          <div class="input-group">
                                              <input type="text" class="form-control timepicker timepicker-24" name="last_order">
                                              <span class="input-group-btn">
                                                  <button class="btn default" type="button">
                                                      <i class="fa fa-clock-o"></i>
                                                  </button>
