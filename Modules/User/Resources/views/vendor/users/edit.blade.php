...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <form id="updateForm" user="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('vendor.users.update',$user->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
