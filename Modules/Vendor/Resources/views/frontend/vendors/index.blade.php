...
<div class="container">
    ...
    <div class="library-cat-block">
        <div class="owl-carousel library_categories">
            ...
            <div class="item">
                <a href="{{ url(route('frontend.categories.index',[
    ...
    <div class="inner-page row">
        ...
        <div class="col-md-3">
            <div class="content-sidebar">
                <form action="{{url(route('frontend.filters.index',$vendor->translate(locale())->slug))}}" method="get">
                    ...
                    <div class="panel-group" id="accordionNo">
                                ...
                                <div class="panel-body">
                                    <div class="smoothscroll maxheight300 color-filter">
                                        <div class="checkboxes one-in-row">
                                            ...
                                            @foreach ($categories as $category)
                                            <input id="check-{{$category->id}}" type="checkbox" name="categories[]" value="{{ $category->id }}">
                                ...
                                <div class="panel-body">
                                    <div class="smoothscroll maxheight300 color-filter">
                                        <div class="checkboxes one-in-row">
                                            ...
                                            <input id="check-{{$brand->id}}" type="checkbox" name="brands[]" value="{{ $brand->id }}">
                                    ...
                                    <div class="filter-price">
                                        <div class="filter-options-content">
                                            <div class="price_slider_wrapper">
                                                <div data-label-reasult="" data-min="{{ $rangePrice['low'] }}" data-max="{{ $rangePrice['high'] }}" data-unit="KWD " class="slider-range-price"
                                                  data-value-min="{{ $rangePrice['low'] }}" data-value-max="{{ $rangePrice['high'] }}">
                                                </div>
                        ...
                        <div class="col-md-12">
                            <p class="form-row form-row-wide">
                                <input type="submit" value="{{ __('vendor::frontend.vendors.btn.filter') }}" class="button-submit btn-block">
                            </p>
                        </div>
                    </div>
                </form>
                            ...
                            <div class="col-md-6 col-xs-6">
                                <div class="toolbar-sort">
                                    ...
                                    <select class="sorter-options form-control" name="sorting">
                                        <option  value="new_arrival" @if (app('request')->input('sorting') == 'new_arrival' || app('request')->input('sorting') == '')
                                          selected
                                        @endif>
                                          {{ __('vendor::frontend.vendors.new_arrival') }}
                                        </option>
                                        <option value="most_selling" @if (app('request')->input('sorting') == 'most_selling')
                                          selected
                                        @endif>
                                ...
                                <div class="product-thumb">
                                    ...
                                    <a href="{{ url(route('frontend.products.index',[
                                      ...
                                      $product->translate(locale())->slug
                                        ...
                                        <img src="{{url($product->image)}}" alt="{{$product->translate(locale())->title}}">
                                    </a>
                                </div>
                                <div class="product-innfo">
                                    ...
                                    @if ($product->qty > 0)
                                      @if (count($product->variants) <= 0)
                                        <form class="form" method="POST" action="{{ url(route('frontend.shopping-cart.create-or-update',$product->translate(locale())->slug)) }}">
                                            @csrf
                                            <div class="row">
                                                    ...
                                                    <class class="tb-qty" data-title="Quantity">
                                                        <div class="quantity">
                                                            <div class="buttons-added">
                                                                ...
                                                                <input type="text" value="{{ Cart::getContent()->get($product->id) ? Cart::getContent()->get($product->id)->quantity : "1"}}" name="qty" class="input-text qty text" size="1" min="1">
