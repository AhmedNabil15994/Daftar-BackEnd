                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @foreach (config('translatable.locales') as $code)
                                      <div class="form-group">
                                          <label class="col-md-2">
                                              {{__('vendor::dashboard.sections.create.form.description')}} - {{ $code }}
                                          </label>
                                          <div class="col-md-9">
                            ...
                            <div class="tab-pane fade in" id="seo">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @foreach (config('translatable.locales') as $code)
                                      <div class="form-group">
                                          <label class="col-md-2">
                                              {{__('vendor::dashboard.sections.create.form.meta_keywords')}} - {{ $code }}
                                          </label>
                                          <div class="col-md-9">
                                    ...
                                    @foreach (config('translatable.locales') as $code)
                                      <div class="form-group">
                                          <label class="col-md-2">
                                              {{__('vendor::dashboard.sections.create.form.meta_description')}} - {{ $code }}
                                          </label>
                                          <div class="col-md-9">
