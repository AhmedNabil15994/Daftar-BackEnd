                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('vendor::dashboard.sections.update.form.description')}} - {{ $code }}
                                        </label>
                                        <div class="col-md-9">
                            ...
                            <div class="tab-pane fade in" id="seo">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('vendor::dashboard.sections.update.form.meta_keywords')}} - {{ $code }}
                                        </label>
                                        <div class="col-md-9">
                                            <textarea name="seo_keywords[{{$code}}]" rows="8" cols="80" class="form-control" data-name="seo_keywords.{{$code}}">{{ $section->translate($code)->seo_keywords }}</textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('vendor::dashboard.sections.update.form.meta_description')}} - {{ $code }}
                                        </label>
                                        <div class="col-md-9">
                                            <textarea name="seo_description[{{$code}}]" rows="8" cols="80" class="form-control" data-name="seo_description.{{$code}}">{{ $section->translate($code)->seo_description }}</textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
