...
@section('title', __('vendor::dashboard.sections.index.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('vendor::dashboard.sections.index.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('vendor::dashboard.sections.datatable.title')}}</th>
                                    <th>{{__('vendor::dashboard.sections.datatable.status')}}</th>
                                    <th>{{__('vendor::dashboard.sections.datatable.created_at')}}</th>
                                    <th>{{__('vendor::dashboard.sections.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('dashboard.sections.deletes')) }}')">
...
responsivePriority:1,
              width: '13%',
              title: '{{__('vendor::dashboard.sections.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {
