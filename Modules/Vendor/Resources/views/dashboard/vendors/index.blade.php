...
@section('title', __('vendor::dashboard.vendors.index.title'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('vendor::dashboard.vendors.index.title')}}</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.vendors.create')) }}" class="btn sbold green">
                                            <i class="fa fa-plus"></i> {{__('apps::dashboard.general.add_new_btn')}}
                                        </a>
                                    </div>
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.vendors.sorting')) }}" class="btn sbold blue">
                                            <i class="fa fa-plus"></i> {{__('apps::dashboard.general.sorting_btn')}}
                                        </a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="form-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    {{__('apps::dashboard.datatable.form.sections')}}
                                                                </label>
                                                                <select name="sections" id="single"
                                                                        class="form-control">
                                                                    <option value="">
                                                                        {{__('apps::dashboard.datatable.form.select_sections')}}
                                                                    </option>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('vendor::dashboard.vendors.datatable.image')}}</th>
                                    <th>{{__('vendor::dashboard.vendors.datatable.status')}}</th>
                                    <th>{{__('vendor::dashboard.vendors.datatable.title')}}</th>
                                    <th>{{__('vendor::dashboard.vendors.datatable.created_at')}}</th>
                                    <th>{{__('vendor::dashboard.vendors.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.vendors.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.vendors.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
...
responsivePriority:1,
                            width: '13%',
                            title: '{{__('vendor::dashboard.vendors.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.vendors.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.vendors.destroy", ":id") }}';
