...
return [
    ...
    'register'          => [
        'messages'      => [
            'not_work'  => 'Registration is for celebrities only, please contact us for enquiries.',
    ...
    'celebrities'       => [
        'mail'          => [
            'btn'               => 'Show the new celebrity',
            'header'            => 'New Celebrity Registered from our app & waiting for the activation ',
            'subject'           => 'New Celebrity Registered ',
        ],
    ],
];
