...
class Coupon extends Model
{
    ...
    protected $fillable = ['code', 'discount_type', 'discount_percentage', 'discount_value', 'max_users', 'user_max_uses', 'expired_at', 'start_at', 'custom_type', 'status', 'max_discount_percentage_value', 'flag'];
    ...
    {
        return $this->hasMany(CouponIpackage::class);
    }
