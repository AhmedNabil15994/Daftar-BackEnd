                            ...
                            <div class="tab-content">
                                                    ...
                                                    @foreach (config('translatable.locales') as $code )
                                                        <li class=" @if($code==app()->getLocale()) active @endif">
                                                            <a href="#colored-rounded-tab-seo-{{$code}}"
                                                               data-toggle="tab"
                                                               aria-expanded="false"> {{__('apps::dashboard.locale.'.$code)}}
                                                            </a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="title[{{$code}}]"
                                                                       ...
                                                                       value="{{$coupon->translate($code)->title}}">
                                            ...
                                            <div class="col-md-9">
                                                <select name="discount_type" id="discount_type" class="form-control"
                                                    ...
                                                    <option value="percentage"
                                                        ...
                                                        {{__('coupon::dashboard.coupons.form.percentage')}}</option>
                                                </select>
                                                ...
                                                {{--<select name="discount_type" id="discount_type" class="form-control"
                                                    ...
                                                    <option value=""></option>
                                                    <option value="value"
                                                        {{($coupon->discount_type == "value") ? ' selected="" ' : ''}}>
                                                        {{__('coupon::dashboard.coupons.form.value')}}</option>
                                                    <option value="percentage"
                                                        {{($coupon->discount_type == "percentage") ? ' selected="" ' : ''}}>
                                                        {{__('coupon::dashboard.coupons.form.percentage')}}</option>
                                                </select>--}}
                                        ...
                                        {{--<div class="form-group discount_type" id="value" style="display: none">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="discount_value"
                                                       ...
                                                       class="form-control" data-name="discount_value">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>--}}

                                        <div class="form-group discount_type"
                                             id="percentage" {{--style="display: none"--}}>
                                            <label class="col-md-2">
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" name="discount_percentage"
                                                       ...
                                                       data-name="discount_percentage" step="0.1">
                                                <div class="help-block"></div>
                                            </div>
                                            <label class="col-md-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" value="{{$coupon->max_discount_percentage_value}}"
                                ...
                                <div class="tab-pane fade in" id="use">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        {{-- </label>--}}
                                        {{-- <div class="col-md-9">--}}
                                        {{-- <input type="text" name="max_users" value="{{$coupon->max_users}}"
                                        class="form-control" data-name="max_users">--}}
                                        {{-- <div class="help-block"></div>--}}
                                        {{-- </div>--}}
                                        {{-- </div>--}}
                                        ...
                                        {{-- </label>--}}
                                        {{-- <div class="col-md-9">--}}
                                        {{-- <input type="text" name="user_max_uses" value="{{$coupon->user_max_uses}}"
                                        class="form-control" data-name="user_max_uses">--}}
                                        {{-- <div class="help-block"></div>--}}
                                        {{-- </div>--}}
                                        {{-- </div>--}}
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group input-medium date time date-picker"
                                                    ...
                                                    <input type="text" id="offer-form" class="form-control"
                                                           name="start_at"
                                                           value="{{$coupon->start_at}}" data-name="start_at">
                                ...
                                <div class="tab-pane fade in" id="custom">
                                    ...
                                    <div class="col-md-10">
                                            ...
                                            <div class="col-md-9">
                                                <div class="mt-radio-inline">
                                                    ...
                                                    <label class="mt-radio mt-radio-outline">
                                                        ...
                                                        <input type="radio" name="coupon_flag" value="vendors"
                                                               onclick="toggleCouponFlag('vendors')"
                                                            {{ $coupon->flag == 'vendors' ? 'checked' : '' }}>
                                                        <span></span>
                                                    </label>
                                                    <label class="mt-radio mt-radio-outline">
                                        ...
                                        <div class="form-group" id="vendorsSection"
                                             style="{{ $coupon->flag == 'vendors' ? 'display: block' : 'display: none' }}">
                                            <label class="col-md-2">
                                                {{__('coupon::dashboard.coupons.form.vendors')}}
                                            </label>
                                            <div class="col-md-9">
                                                <select name="vendor_ids[]" multiple id="single"
                                                        class="form-control select2" data-name="vendor_ids[]">
                                                    <option value=""></option>

                                                    @foreach ($vendors as $vendor)
                                                        <option value="{{ $vendor['id'] }}"
                                                            {{ $coupon->vendors->contains($vendor->id) ? 'selected':'' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select name="user_ids[]" multiple id="single"
