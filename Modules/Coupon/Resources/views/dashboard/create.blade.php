                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                {{--<select name="discount_type" id="discount_type" class="form-control"
                                                    ...
                                                    <option value=""></option>
                                                    <option
                                                        value="value"> {{__('coupon::dashboard.coupons.form.value')}}
                                                    </option>
                                                    <option value="percentage">
                                                        {{__('coupon::dashboard.coupons.form.percentage')}}</option>
                                                </select>--}}
                                        ...
                                        <div class="form-group discount_type"
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" min="0" max="100" name="discount_percentage"
                                                       class="form-control" data-name="discount_percentage" step="0.1">
                                                <div class="help-block"></div>
                                            </div>
                                            <label class="col-md-2">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="max_discount_percentage_value"
                                                       class="form-control"
                                ...
                                <div class="tab-pane fade in" id="use">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        {{-- </label>--}}
                                        {{-- <div class="col-md-9">--}}
                                        {{-- <input type="text" name="max_users" class="form-control" data-name="max_users">--}}
                                        {{-- <div class="help-block"></div>--}}
                                        {{-- </div>--}}
                                        {{-- </div>--}}
                                        ...
                                        {{-- </label>--}}
                                        {{-- <div class="col-md-9">--}}
                                        {{-- <input type="text" name="user_max_uses" class="form-control" data-name="user_max_uses">--}}
                                        {{-- <div class="help-block"></div>--}}
                                        {{-- </div>--}}
                                        {{-- </div>--}}
                                ...
                                <div class="tab-pane fade in" id="custom">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group" id="vendorsSection" style="display: none">
                                            <label class="col-md-2">
                                                {{__('coupon::dashboard.coupons.form.vendors')}}
                                            </label>
                                            <div class="col-md-9">
