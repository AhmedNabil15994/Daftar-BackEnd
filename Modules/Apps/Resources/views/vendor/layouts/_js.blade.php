  ...
  $(document).ready(function()
  {
    ...
    $('#reportrange').daterangepicker({
        ...
        ranges: {
           ...
           '{{__('apps::vendor.general.date_range.yesterday')}}'     : [moment().subtract(1, 'days'), moment().subtract(1, 'days')],
           '{{__('apps::vendor.general.date_range.7days')}}'         : [moment().subtract(6, 'days'), moment()],
           '{{__('apps::vendor.general.date_range.30days')}}'        : [moment().subtract(29, 'days'), moment()],
           '{{__('apps::vendor.general.date_range.month')}}'         : [moment().startOf('month'), moment().endOf('month')],
           '{{__('apps::vendor.general.date_range.last_month')}}'    : [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')],
        },
          @if (is_rtl() == 'rtl')
          opens: 'left',
          @endif
...
pusher.subscribe('vendor-daftar-channel').bind('vendor-log', function(data) {
