...
class OrderDriverRequest extends FormRequest
{
        ...
        switch ($this->getMethod()) {
            ...
            case 'PUT':
                ...
                return [
                    ...
                    'payment_method' => 'required|exists:payments,code',
                    'notes' => 'nullable',
                ];
        }
    }
    ...
    public function messages()
    {
        $v = [
            ...
            'payment_method.required' => __('order::dashboard.order_drivers.validation.payment_method.required'),
            'payment_method.exists' => __('order::dashboard.order_drivers.validation.payment_method.exists'),
        ];
        return $v;
    }
}
