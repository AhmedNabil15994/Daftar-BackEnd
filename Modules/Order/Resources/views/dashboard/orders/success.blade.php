...
@section('title', __('order::dashboard.orders.success.title'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('order::dashboard.orders.success.title') }}</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                            ...
                            <div class="details">
                                ...
                                <div class="desc">{{ __('order::dashboard.orders.success.statistics.success_orders') }}</div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <a class="dashboard-stat dashboard-stat-v2 yellow" href="#">
                            ...
                            <div class="details">
                                ...
                                <div class="desc">{{ __('order::dashboard.orders.success.statistics.failed_orders') }}</div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                            ...
                            <div class="details">
                                ...
                                <div class="desc">{{ __('order::dashboard.orders.success.statistics.canceled_orders') }}</div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                            ...
                            <div class="details">
                                ...
                                <div class="desc">{{ __('order::dashboard.orders.success.statistics.returned_orders') }}
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">
                                    {{ __('order::dashboard.orders.success.title') }}
                                </span>
                            </div>
                        </div>
                        ...
                        @include('order::dashboard.shared._bulk_order_actions', ['printPage' => 'success'])
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.orders.success.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
