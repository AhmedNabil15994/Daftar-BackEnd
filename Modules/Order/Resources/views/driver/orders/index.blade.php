                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('order::driver.orders.datatable.state')}}</th>
                                    <th>{{__('order::driver.orders.datatable.username')}}</th>
                                    <th>{{__('order::driver.orders.datatable.mobile')}}</th>
   ...
   function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          columns: [
            ...
            {data: 'username' 	      , className: 'dt-center' , orderable: false},
            {data: 'mobile' 	        , className: 'dt-center' , orderable: false},
