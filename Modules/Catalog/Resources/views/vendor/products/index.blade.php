...
@section('title', __('catalog::vendor.products.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('catalog::vendor.products.routes.index')}}</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('vendor.products.create')) }}" class="btn sbold green">
                                            <i class="fa fa-plus"></i> {{__('apps::vendor.general.add_new_btn')}}
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{__('catalog::dashboard.products.datatable.cost_price')}}</th>
                                        <th>{{__('catalog::dashboard.products.datatable.qty')}}</th>
                                        <th>{{__('catalog::dashboard.products.datatable.sold_qty')}}</th>
                                        <th>{{__('catalog::dashboard.products.datatable.sku')}}</th>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('vendor.products.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('vendor.products.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columns: [
                        ...
                        {data: 'cost_price', className: 'dt-center'},
                        {data: 'qty', className: 'dt-center'},
                        {data: 'sold_qty', className: 'dt-center', orderable: false},
                        {data: 'sku', className: 'dt-center'},
                        {data: 'vendor', className: 'dt-center', orderable: false},
                        {data: "categories", render: "[ , ].title", orderable: false},
...
responsivePriority:1,
                            width: '13%',
                            title: '{{__('catalog::vendor.products.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("vendor.products.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("vendor.products.destroy", ":id") }}';
