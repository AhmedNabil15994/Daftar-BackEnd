                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="brand_id" id="single" class="form-control select2" data-name="brand_id">
                                                <option value=""></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch" id="test" data-size="small" name="most_popular" {{($product->most_popular == 1) ? ' checked="" ' : ''}}>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade in" id="new_arrival">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" id="new-arraival-status" class="isUnchecked" name="arrival_status" onclick="checkFunction()" @if ($product->newArrival)
                                            {{($product->newArrival->status == 1) ? ' checked="" ' : ''}}
                                            @endif>
                                            <input type="hidden" class="isUnchecked" name="arrival_status" value="0" @if ($product->newArrival)
                                    ...
                                    <div class="arrival-form" style="display:none">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                                                    <input type="text" class="form-control" name="arrival_start_at" disabled id="arrival-form" data-name="arrival_start_at" value="{{ $product->newArrival ? $product->newArrival->start_at : '' }}">
                                                    <span class="input-group-btn">
                                                        <button class="btn default" type="button">
                                                            <i class="fa fa-calendar"></i>
                                                        </button>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                                                    <input type="text" class="form-control" name="arrival_end_at" disabled id="arrival-form" data-name="arrival_end_at" value="{{ $product->newArrival ? $product->newArrival->end_at : '' }}">
                                                    <span class="input-group-btn">
                                                        <button class="btn default" type="button">
                                                            <i class="fa fa-calendar"></i>
                                                        </button>
                                                          ...
                                                          <div class="col-md-offset-2">
                                                            <div class="mt-checkbox-list">
                                                                ...
                                                                <label class="mt-checkbox mt-checkbox-outline">
                                                                    <input type="checkbox" name="option_values" value="{{$value->id}}" data-name="option_values[{{ $option->id }}]"/>
                            ...
                            <div class="tab-pane fade in" id="gallery">
                                <h3 class="page-title">{{__('catalog::dashboard.products.form.tabs.gallery')}}</h3>
                                <div class="col-md-10">
                                    <div class="galleryForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-9">
                                                <input class="form-control images" type="hidden" name="images_old[]" data-name="images" value="{{$image->image}}">
                                                <input class="form-control images" type="file" name="images[]" data-name="images" value="{{ url($image->image) }}">
                                                <div class="help-block"></div>
                                                <span class="input-group-btn">
                                    ...
                                    <div class="getGalleryForm" style="display:none">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-9">
                                                <input class="form-control images" type="file" name="images[]" data-name="images">
                                                <div class="help-block"></div>
                                                <span class="input-group-btn">
                                                    <a data-input="images" data-preview="holder" class="btn btn-danger delete-gallery">
                                                        <i class="glyphicon glyphicon-remove"></i>
                            ...
                            <div class="tab-pane fade in" id="seo">
                                ...
                                <div class="col-md-10">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                          <textarea name="seo_keywords[{{$code}}]" rows="8" cols="80" class="form-control" data-name="seo_keywords.{{$code}}">{{ $product->translate($code)->seo_keywords }}</textarea>
                                          <div class="help-block"></div>
                                      </div>
                                  </div>
                                  @endforeach
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                          <textarea name="seo_description[{{$code}}]" rows="8" cols="80" class="form-control" data-name="seo_description.{{$code}}">{{ $product->translate($code)->seo_description }}</textarea>
                                          <div class="help-block"></div>
                                      </div>
                                  </div>
                                  @endforeach
