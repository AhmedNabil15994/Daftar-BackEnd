...
@section('title', __('catalog::dashboard.categories.sorting.title'))
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('catalog::dashboard.categories.sorting.title')}}</a>
                </li>
            </ul>
        </div>
                          ...
                          <div class="portlet light">
                              <div class="portlet-body">
                                  <ul id="sortable" class="dd-list">
                                      ...
                                      <li id="categories-{{$category->id}}" class="dd-item">
