                            ...
                            <div class="tab-content">
                                <div class="tab-pane active fade in" id="category_level">
                                    ...
                                    <div id="jstree">
                                        ...
                                        @include('catalog::dashboard.tree.categories.edit',['mainCategories' => $mainCategories])
                                    </div>
                                </div>
                                <div class="tab-pane fade in" id="global_setting">
                                    ...
                                    <div class="col-md-10">
                                        @foreach (config('translatable.locales') as $code)
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('catalog::dashboard.categories.form.title')}} - {{ $code }}
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" name="title[{{$code}}]" class="form-control"
                                                           data-name="title.{{$code}}"
                                                           value="{{$category->translate($code)->title}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                @include('core::dashboard.shared.file_upload', ['image' => $category->image])
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('catalog::dashboard.categories.form.is_navbar')}}
                                            </label>
                                            <div class="col-md-9">
                                                <input type="checkbox" class="make-switch" id="test" data-size="small"
                                                       name="is_navbar" {{($category->is_navbar == 1) ? ' checked="" ' : ''}}>
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        @if ($category->trashed())
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('user::dashboard.users.update.form.restore')}}
                                                </label>
                                                <div class="col-md-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="seo_keywords[{{$code}}]" rows="8" cols="80"
                                                              class="form-control"
                                                              data-name="seo_keywords.{{$code}}">{{$category->translate($code)->seo_keywords}}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="seo_description[{{$code}}]" rows="8" cols="80"
                                                              class="form-control"
                                                              data-name="seo_description.{{$code}}">{{$category->translate($code)->seo_description}}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        @endforeach
