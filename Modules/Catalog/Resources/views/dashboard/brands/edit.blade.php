        ...
        <div class="page-content">
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('dashboard.brands.update',$brand->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    ...
                                    <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="title[{{$code}}]" class="form-control"
                                                           ...
                                                           value="{{ $brand->translate($code)->title }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                @include('core::dashboard.shared.file_upload', ['image' => $brand->image])
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="seo_keywords[{{$code}}]" rows="8" cols="80"
                                                              class="form-control"
                                                              data-name="seo_keywords.{{$code}}">{{ $brand->translate($code)->seo_keywords }}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="seo_description[{{$code}}]" rows="8" cols="80"
                                                              class="form-control"
                                                              data-name="seo_description.{{$code}}">{{ $brand->translate($code)->seo_description }}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        @endforeach
