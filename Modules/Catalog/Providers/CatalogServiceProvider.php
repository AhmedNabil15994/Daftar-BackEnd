...
use Modules\Catalog\Console\AlertStockProductCommand;
use Modules\Catalog\Console\StockProductCommand;
...
class CatalogServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands([
            AlertStockProductCommand::class,
            StockProductCommand::class,
        ]);
    }
