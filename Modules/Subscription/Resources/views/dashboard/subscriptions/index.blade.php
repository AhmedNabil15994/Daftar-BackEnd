...
@section('title', __('subscription::dashboard.subscriptions.index.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('subscription::dashboard.subscriptions.index.title')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.subscriptions.create')) }}" class="btn sbold green">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('subscription::dashboard.subscriptions.datatable.start_at')}}</th>
                                    <th>{{__('subscription::dashboard.subscriptions.datatable.end_at')}}</th>
                                    ...
                                    <th>{{__('subscription::dashboard.subscriptions.datatable.original_price')}}</th>
                                    <th>{{__('subscription::dashboard.subscriptions.datatable.vendor')}}</th>
                                    <th>{{__('subscription::dashboard.subscriptions.datatable.package')}}</th>
                                    <th>{{__('subscription::dashboard.subscriptions.datatable.created_at')}}</th>
                                    <th>{{__('subscription::dashboard.subscriptions.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('dashboard.subscriptions.deletes')) }}')">
      ...
      $('#dataTable').DataTable({
          "createdRow": function( row, data, dataIndex ) {
             if ( data["deleted_at"] != null ) {
               ...
               if ( data["original_price"] != data["total"] ) {
          ...
          columns: [
            ...
            {data: 'original_price' 	, className: 'dt-center'},
