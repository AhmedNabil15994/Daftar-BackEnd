...
@section('title', __('subscription::dashboard.packages.index.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('subscription::dashboard.packages.index.title')}}</a>
                </li>
            </ul>
        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('subscription::dashboard.packages.datatable.title')}}</th>
                                    <th>{{__('subscription::dashboard.packages.datatable.status')}}</th>
                                    <th>{{__('subscription::dashboard.packages.datatable.price')}} (KWD)</th>
                                    <th>{{__('subscription::dashboard.packages.datatable.special_price')}} (KWD)</th>
                                    <th>{{__('subscription::dashboard.packages.datatable.months')}}</th>
                                    <th>{{__('subscription::dashboard.packages.datatable.created_at')}}</th>
                                    <th>{{__('subscription::dashboard.packages.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
      ...
      $('#dataTable').DataTable({
        "createdRow": function( row, data, dataIndex ) {
          ...
          columns: [
            ...
            {data: 'special_price' 	  , className: 'dt-center'},
            {data: 'months' 	        , className: 'dt-center'},
...
responsivePriority:1,
              width: '13%',
              title: '{{__('subscription::dashboard.packages.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {
