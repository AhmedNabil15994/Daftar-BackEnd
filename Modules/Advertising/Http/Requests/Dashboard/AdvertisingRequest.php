...
class AdvertisingRequest extends FormRequest
{
    ...
    public function rules()
    {
        switch ($this->getMethod()) {
            ...
            case 'POST':
                $rules = [
                    'link_type' => 'nullable|in:external,product,category,brand,vendor',
...
//                    'image' => 'required',
    ...
    public function messages()
    {
        $v = [
            ...
            'brand_id.required' => __('advertising::dashboard.advertising.validation.brand_id.required'),
            'brand_id.exists' => __('advertising::dashboard.advertising.validation.brand_id.exists'),
            
            'vendor_id.required' => __('advertising::dashboard.advertising.validation.vendor_id.required'),
            'vendor_id.exists' => __('advertising::dashboard.advertising.validation.vendor_id.exists'),
