                                                ...
                                                <select name="group_id" class="form-control" data-name="group_id">
                                                    ...
                                                    @foreach ($groups as $k => $group)
                                                        <option value="{{ $group->id }}"
                                                            {{ $advertisingGroup->id == $group->id ? 'selected' : '' }}>
